...
- The gate performs no external Provider request. Controlled activation evidence is recorded separately in `docs/live-verification.md`; it does not turn missing Voyage/AIS observation/official-alert evidence into `verified_live`.
...
## V3 Real Data Activation Runtime — 2026-08-29
...
- Current verification state: V3 P0/P1A/P1B/P2A/P2B/P2C/P3A/P3B, P3 Feed Freshness, source-isolated Feed Runtime, Calendar/Port/Weather activation, Translation T1 Foundation, the accepted HANSA VesselAPI Voyage/ETA live evidence and the Readiness Review repair are recorded in `docs/status.md`; Readiness shares the Node/ABI/pnpm/better-sqlite3 contract between API and CLI and validates the exact profile-specific Job set. It includes typecheck, production build, native better-sqlite3 read/write, migration-aware persistence smokes, Real activation smoke and built Nitro HTTP smoke. VesselAPI Voyage/ETA Provider live verification is complete, while focus-port mapping for the observed `CNYPG` remains `coverage_pending`; live AIS and official-alert criteria remain independently bounded. Real Translation Providers and later business phases remain deferred.
