...
The current local suite is 296/296 with production build, typecheck, the four native restart smokes (P0/P2C/P3A/P3B) and an all-green `pnpm lint`; the 2026-08-24 closeout repair removed the four pre-existing lint errors and the follow-up repair fixed accepted-record `sourceUpdatedAt` handling.
