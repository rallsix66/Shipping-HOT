...
The current local suite is 317/317 with production build, typecheck, the four prior native restart smokes plus the P3 Feed current/history restart smoke and an all-green `pnpm lint`; the earlier 296/296 count is historical and superseded by the 2026-08-25 Readiness Review and P3 Feed Freshness Batch 1 gates. The 2026-08-24 closeout repair removed the four pre-existing lint errors and the follow-up repair fixed accepted-record `sourceUpdatedAt` handling.
