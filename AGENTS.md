...
- The current working branch is `main` at `87d18c5c39725112ddf58d993c8fe1433f42234e` (`fix: distinguish required calendar cache sources`). The fixed annual reference calendar slice is uncommitted; its current verification is in `docs/status.md`. Retain the untracked diagnostic artifacts. Historical P7 remains `codex/shipping-hot-v3-real-data@ed2c8448699971328b23247508a7b91fb537ab6b`; never rewrite that seal as full capability coverage.
