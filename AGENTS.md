...
- The current working branch is `main` at the post-seal documentation baseline `f338ccffb5943c269102afaba41d520e2cf4121e`; the historical P7 acceptance branch is `codex/shipping-hot-v3-real-data` at seal commit `ed2c8448699971328b23247508a7b91fb537ab6b`. Keep this distinction: Phase 1 work on `main` must not rewrite the historical P7 acceptance record or describe the seal as full capability coverage.
