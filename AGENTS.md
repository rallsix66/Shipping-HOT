...
- The current working branch is `main` at `e1a73c3bd964a7ade368051ef1807228c5bc8abe` (`fix: complete phase 1 calendar sync and preserve runtime evidence`); the current Phase 1 calendar count repair and controlled Web diagnosis remain uncommitted, with no real-Provider re-verification. The historical P7 acceptance branch is `codex/shipping-hot-v3-real-data` at seal commit `ed2c8448699971328b23247508a7b91fb537ab6b`. Keep this distinction: Phase 1 work on `main` must not rewrite the historical P7 acceptance record or describe the seal as full capability coverage.
