...
- The current working branch is `main`; the historical P7 acceptance branch is `codex/shipping-hot-v3-real-data`. Both currently point to seal commit `ed2c8448699971328b23247508a7b91fb537ab6b`; this distinction preserves the historical acceptance record without presenting that branch as the current checkout.
